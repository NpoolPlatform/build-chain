...
func (_Erc20 *Erc20Caller) FreezeOf(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "freezeOf", arg0)
...
//
// Solidity: function freezeOf(address ) returns(uint256)
func (_Erc20 *Erc20Session) FreezeOf(arg0 common.Address) (*big.Int, error) {
	return _Erc20.Contract.FreezeOf(&_Erc20.CallOpts, arg0)
}

// FreezeOf is a free data retrieval call binding the contract method 0xcd4217c1.
//
// Solidity: function freezeOf(address ) returns(uint256)
func (_Erc20 *Erc20CallerSession) FreezeOf(arg0 common.Address) (*big.Int, error) {
	return _Erc20.Contract.FreezeOf(&_Erc20.CallOpts, arg0)
}
...
func (_Erc20 *Erc20Transactor) Freeze(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "freeze", _value)
}

// Freeze is a paid mutator transaction binding the contract method 0xd7a78db8.
//
// Solidity: function freeze(uint256 _value) returns(bool success)
func (_Erc20 *Erc20Session) Freeze(_value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Freeze(&_Erc20.TransactOpts, _value)
}

// Freeze is a paid mutator transaction binding the contract method 0xd7a78db8.
//
// Solidity: function freeze(uint256 _value) returns(bool success)
func (_Erc20 *Erc20TransactorSession) Freeze(_value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Freeze(&_Erc20.TransactOpts, _value)
}
...
func (_Erc20 *Erc20Transactor) Unfreeze(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "unfreeze", _value)
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6623fc46.
//
// Solidity: function unfreeze(uint256 _value) returns(bool success)
func (_Erc20 *Erc20Session) Unfreeze(_value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Unfreeze(&_Erc20.TransactOpts, _value)
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6623fc46.
//
// Solidity: function unfreeze(uint256 _value) returns(bool success)
func (_Erc20 *Erc20TransactorSession) Unfreeze(_value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Unfreeze(&_Erc20.TransactOpts, _value)
}
...
func (_Erc20 *Erc20Transactor) WithdrawEther(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "withdrawEther", amount)
}

// WithdrawEther is a paid mutator transaction binding the contract method 0x3bed33ce.
//
// Solidity: function withdrawEther(uint256 amount) returns()
func (_Erc20 *Erc20Session) WithdrawEther(amount *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.WithdrawEther(&_Erc20.TransactOpts, amount)
}

// WithdrawEther is a paid mutator transaction binding the contract method 0x3bed33ce.
//
// Solidity: function withdrawEther(uint256 amount) returns()
func (_Erc20 *Erc20TransactorSession) WithdrawEther(amount *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.WithdrawEther(&_Erc20.TransactOpts, amount)
}
...
// Erc20FreezeIterator is returned from FilterFreeze and is used to iterate over the raw logs and unpacked data for Freeze events raised by the Erc20 contract.
type Erc20FreezeIterator struct {
	Event *Erc20Freeze // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc20FreezeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc20FreezeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc20FreezeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc20Freeze represents a Freeze event raised by the Erc20 contract.
type Erc20Freeze struct {
	From  common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}
...
func (_Erc20 *Erc20Filterer) FilterFreeze(opts *bind.FilterOpts, from []common.Address) (*Erc20FreezeIterator, error) {
	...
	logs, sub, err := _Erc20.contract.FilterLogs(opts, "Freeze", fromRule)
	if err != nil {
		return nil, err
	}
	return &Erc20FreezeIterator{contract: _Erc20.contract, event: "Freeze", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Freeze(address indexed from, uint256 value)
func (_Erc20 *Erc20Filterer) WatchFreeze(opts *bind.WatchOpts, sink chan<- *Erc20Freeze, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc20.contract.WatchLogs(opts, "Freeze", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc20Freeze)
				if err := _Erc20.contract.UnpackLog(event, "Freeze", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Freeze(address indexed from, uint256 value)
func (_Erc20 *Erc20Filterer) ParseFreeze(log types.Log) (*Erc20Freeze, error) {
	event := new(Erc20Freeze)
	if err := _Erc20.contract.UnpackLog(event, "Freeze", log); err != nil {
		return nil, err
	}
...
// Erc20UnfreezeIterator is returned from FilterUnfreeze and is used to iterate over the raw logs and unpacked data for Unfreeze events raised by the Erc20 contract.
type Erc20UnfreezeIterator struct {
	Event *Erc20Unfreeze // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc20UnfreezeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc20UnfreezeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc20UnfreezeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc20Unfreeze represents a Unfreeze event raised by the Erc20 contract.
type Erc20Unfreeze struct {
	From  common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}
...
func (_Erc20 *Erc20Filterer) FilterUnfreeze(opts *bind.FilterOpts, from []common.Address) (*Erc20UnfreezeIterator, error) {
	...
	logs, sub, err := _Erc20.contract.FilterLogs(opts, "Unfreeze", fromRule)
	if err != nil {
		return nil, err
	}
	return &Erc20UnfreezeIterator{contract: _Erc20.contract, event: "Unfreeze", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Unfreeze(address indexed from, uint256 value)
func (_Erc20 *Erc20Filterer) WatchUnfreeze(opts *bind.WatchOpts, sink chan<- *Erc20Unfreeze, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc20.contract.WatchLogs(opts, "Unfreeze", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc20Unfreeze)
				if err := _Erc20.contract.UnpackLog(event, "Unfreeze", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Unfreeze(address indexed from, uint256 value)
func (_Erc20 *Erc20Filterer) ParseUnfreeze(log types.Log) (*Erc20Unfreeze, error) {
	event := new(Erc20Unfreeze)
	if err := _Erc20.contract.UnpackLog(event, "Unfreeze", log); err != nil {
		return nil, err
	}
