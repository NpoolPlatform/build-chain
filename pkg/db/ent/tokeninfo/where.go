...
func ID(id uint32) predicate.TokenInfo {
...
func IDEQ(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func IDIn(ids ...uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func IDGTE(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func IDLT(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func IDLTE(id uint32) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntID(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntIDEQ(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEntID), v))
	})
}
...
func EntIDNEQ(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntIDIn(vs ...uuid.UUID) predicate.TokenInfo {
...
func EntIDNotIn(vs ...uuid.UUID) predicate.TokenInfo {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func EntIDGT(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntIDGTE(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntIDLT(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
...
func EntIDLTE(v uuid.UUID) predicate.TokenInfo {
	return predicate.TokenInfo(func(s *sql.Selector) {
