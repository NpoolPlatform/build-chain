...
func (dcu *DeployedCoinUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *DeployedCoinUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (dcuo *DeployedCoinUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *DeployedCoinUpdateOne {
...
func (dcuo *DeployedCoinUpdateOne) sqlSave(ctx context.Context) (_node *DeployedCoin, err error) {
	...
	_spec.Modifiers = dcuo.modifiers
