...
func (ciu *CoinsInfoUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *CoinsInfoUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (ciuo *CoinsInfoUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *CoinsInfoUpdateOne {
