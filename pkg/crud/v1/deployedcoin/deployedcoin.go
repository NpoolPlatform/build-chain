...
func Rows(ctx context.Context, conds cruder.Conds, offset, limit int) ([]*npool.DeployedCoin, int, error) {
	var err error
...
func All(ctx context.Context, conds cruder.Conds) ([]*npool.DeployedCoin, int, error) {
	var err error
	rows := []*ent.DeployedCoin{}
	var total int
